...
\begin{frame}
	...
	\begin{problock}{Internet of Energy}
		\begin{itemize}
			\vspace*{0.3em}
			\item {\large Produzione da fonti rinnovabili, distribuzione e stoccaggio dell'Energia}
			\vspace*{0.3em}
			\item {\large Batterie preformanti e Veicoli ``intelligenti''}
			\vspace*{0.3em}			
			\item {\large Servizi di supporto alla ricarica}
		\end{itemize}	
	\end{problock}
...
\begin{frame}
	...
	\begin{problock}{Componenti}
		\begin{itemize}
			...
			\item {\large Semantic Information Broker}
...
\begin{frame}
	...
	\begin{problock}{Funzionalità}
		\begin{itemize}[<+->]
			...
			\item {\large Profilo Altimetrico \& Consumo Energetico}
			\item {\large Monitoraggio batteria}
...
\begin{frame}
	...
	\begin{problock}{Libreria IoE}
		\begin{itemize}
			\item {\large Rappresentazione a Oggetti delle classi dell'ontologia}
			\item {\large Semplificate operazioni CRUD}
			\item {\large Condivisa tra Servizio Cittadino e Applicazione Mobile}
		\end{itemize}
	\end{problock}
	...
	\begin{problock}{Servizio Cittadino}
		\begin{itemize}
			\item {\large Pool di Thread}
			\item {\large Pool di Oggetti}
			\item {\large Cache}
		\end{itemize}
	\end{problock}
	...
	\begin{problock}{Libreria UniboGeoTool}
		\begin{itemize}[<+->]
			\item {\large Dati altimetrici (Google - SRTM)}
			\item {\large Percorso in strada (Google)}
		\end{itemize}
	\end{problock}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item {\large An interoperable architecture for mobile smart services over the Internet of Energy (pubblicato)\\ \vspace{0.5em} Luciano Bononi; Marco Di Felice; Alfredo D'Elia; Randolf Mock; Federico Montori; Francesco Morandi; Luca Roffia; Simone Rondelli; , Tullio S. Cinotti; Fabio Vergari}
		\item {\large An Integrated Simulation Framework to Model Electric Vehicles Operations and Services (sottoposto)\\ \vspace{0.5em} Luciano Bononi; Marco Di Felice; Alfredo D'Elia; Randolf Mock; Simone Rondelli; , Tullio S. Cinotti; Fabio Vergari}
	\end{itemize}
\end{frame}
...
%	\begin{problock}{SUMO}
%		\begin{itemize}
%			\item {\large Simulatore Traffico Urbano}
%			\item {\large Modellazione dello scenario stradale di Bologna}
%		\end{itemize}	
%	\end{problock}
%	
%	\begin{center}
...
%		\begin{itemize}
%			\item {\large Simulatore a eventi discreti}
%			\item {\large Logica di funzionamento dei veicoli}
%			\item {\large Comportamento degli utenti}
%			\item {\large Modello di carica e scarica della batteria}
%		\end{itemize}	
%	\end{problock}
%	
%	\begin{center}
...
%		\begin{itemize}
%			\item {\large Modulo di OMNeT++}
%			\item {\large Comunicazione tra OMNeT++ e SUMO}
%		\end{itemize}	
%	\end{problock}
%	
%	\begin{center}
